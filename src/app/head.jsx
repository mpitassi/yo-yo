export default function Head() {
  return (
    <>
      <title>Miles Pitassi</title>
      <meta name="description" content="Im Miles, a data analyst and researcher for sports. Im currently a Research Scientist Intern for the Chicago Blackhawks, developing models using the NHLs puck and player tracking data." />

      {/* Facebook Meta Tags */}
      <meta property="og:url" content="https://miles-pitassi.com" />
      ...
      <meta property="twitter:domain" content="miles-pitassi.com" />
